...
let
  sources = {
    ...
    "vscode-css-languageservice-5.1.1" = {
      ...
      version = "5.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/vscode-css-languageservice/-/vscode-css-languageservice-5.1.1.tgz";
        sha512 = "QW0oe/g2y5E2AbVqY7FJNr2Q8uHiAHNSFpptI6xB8Y0KgzVKppOcIVrgmBNzXhFp9IswAwptkdqr8ExSJbqPkQ==";
      };
    };
    "vscode-html-languageservice-4.0.3" = {
      ...
      version = "4.0.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/vscode-html-languageservice/-/vscode-html-languageservice-4.0.3.tgz";
        sha512 = "34KPIgRHVInT+TiFNmfiPFDrUAOOLuySNP2h0pMxBu1ObAbSixSqB3BMQFxIHz9hrGd3X0DEvi5YkobDxs4rWw==";
      };
    };
...
in
{
  ...
  "@yaegassy/coc-intelephense" = nodeEnv.buildNodePackage {
    ...
    version = "0.8.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@yaegassy/coc-intelephense/-/coc-intelephense-0.8.0.tgz";
      sha512 = "YCwTes5yRPIZGYM47q08b1AE3kHyFMgMrgmnS0+XqUmwISCt+qSyan6AeyVzeb2y+fl57zAT6oFX69SIzZ/xBg==";
    };
    dependencies = [
      sources."@bmewburn/js-beautify-1.13.0"
      sources."@bmewburn/minidom-1.0.1"
