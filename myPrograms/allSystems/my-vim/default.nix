...
in {
  options = {
    programs.my-vim = {
      enable = mkEnableOption "activate my vim configuration";
    };
  };

  config = mkIf config.programs.my-vim.enable {
    programs.vim.enable = true;
    home.file.".vim/coc-settings.json".text = cocNvim.cocSettingsFile;
